...
\label{apx:technical_proofs}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
We prove the theorem in three steps. 
First, we derive an estimate for the $L^2$-distance of~$\widehat{\Vv}_{t_i}$ to the discretised~$Y_{t_i}$. Next, we use this to prove the estimate for the $Y$-component and finally for the $Z$-components. 
