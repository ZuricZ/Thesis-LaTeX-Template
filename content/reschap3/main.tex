...
%In this paper, we deal with variance reduction for option pricing. 
...
%Stationary point is the solution to the Euler-Lagrange equation
...
% where a change of variable~$\psi\mapsto\sqrt\psi$ was made in infimum.
