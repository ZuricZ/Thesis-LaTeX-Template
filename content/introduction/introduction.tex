...
\begin{proposition}[Proposition 3 in~\cite{Gonon2023ApproximationSystems}]\label{prop:UATRWNN}
...
% is currently being developed and focuses on ``The grey Bergomi model" investigating its 
