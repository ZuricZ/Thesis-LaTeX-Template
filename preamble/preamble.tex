...
% Math packages
\usepackage{amsmath} % setting placements of limits [intlimits,sumlimits]             
\usepackage{amssymb}
\usepackage{amstext}	
\usepackage{amsfonts}
...
% abstract boolean to true for next `\chapter*` command...
\newcommand{\abstracttitleandname}{%
 \if@openright\cleardoublepage\else\clearpage\fi
\textbf{\LARGE{\thesistitle}}\par
\large{\emph{\name}}\par %
\normalsize{Thesis advisor: \emph{\advisor}}\par\vspace*{\baselineskip}
\abstracttrue}% Author: \hspace*{2em}
\makeatother
